...
def run_step(cfg, state, info, plots, memory, provider, diverse_query, strategy_agents, exp_path, trading_records, mode):
    ...
    # plot kline
    kline_path = plots.plot_kline(state=state, info=info, save_dir=save_dir)
    params.update({
    ...
    prepared_latest_market_intelligence_params = latest_market_intelligence_summary.convert_to_params(state=state,
                                                                                        info=info,
                                                                                        params=params,
                                                                                        memory=memory,
                                                                                        provider=provider,
    ...
    prepared_low_level_reflection_params =low_level_reflection.convert_to_params(state=state,
                                         info=info,
                                         params=params,
                                         memory=memory,
                                         provider=provider,
