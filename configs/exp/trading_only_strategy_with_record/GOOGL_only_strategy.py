...
asset_type = "company"
workdir = "workdir/only_strategy_trading_with_record"
...
valid_decision_template_path = "res/prompts/template/valid/only_strategy_trading/decision_with_record.html"
