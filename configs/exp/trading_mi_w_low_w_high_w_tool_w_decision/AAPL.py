...
selected_asset = "AAPL"
asset_type = "company"
workdir = "workdir/trading_mi_w_low_w_high_w_tool_w_decision"
...
train_latest_market_intelligence_summary_template_path = "res/prompts/template/train/trading_mi-w-low-w-high-w-tool-w-decision/latest_market_intelligence_summary.html"
train_past_market_intelligence_summary_template_path = "res/prompts/template/train/trading_mi-w-low-w-high-w-tool-w-decision/past_market_intelligence_summary.html"
train_low_level_reflection_template_path = "res/prompts/template/train/trading_mi-w-low-w-high-w-tool-w-decision/low_level_reflection.html"
train_high_level_reflection_template_path = "res/prompts/template/train/trading_mi-w-low-w-high-w-tool-w-decision/high_level_reflection.html"
train_decision_template_path = "res/prompts/template/train/trading_mi-w-low-w-high-w-tool-w-decision/decision.html"

valid_latest_market_intelligence_summary_template_path = "res/prompts/template/valid/trading_mi-w-low-w-high-w-tool-w-decision/latest_market_intelligence_summary.html"
valid_past_market_intelligence_summary_template_path = "res/prompts/template/valid/trading_mi-w-low-w-high-w-tool-w-decision/past_market_intelligence_summary.html"
valid_low_level_reflection_template_path = "res/prompts/template/valid/trading_mi-w-low-w-high-w-tool-w-decision/low_level_reflection.html"
valid_high_level_reflection_template_path = "res/prompts/template/valid/trading_mi-w-low-w-high-w-tool-w-decision/high_level_reflection.html"
valid_decision_template_path = "res/prompts/template/valid/trading_mi-w-low-w-high-w-tool-w-decision/decision.html"
